...
console.log(nextSpan); //=> trả về tag html cùng cấp phía sau
const span2 = document.querySelector(".span-2");
const previousSpan = span2.previousElementSibling;
console.log(previousSpan); //=> trả về tag html cùng cấp ở phía trước
...
console.log(span.firstChild); //trả về text
console.log(span.firstElementChild); //trả về html
...
// 6. nextSibling vs previous Sibling;

console.log(span.nextSibling.nextSibling); //trả về text
console.log(span.previousSibling); //trả về text